    ...
    $('#country').change(function(){
        ...
        switch(cty){
            ...
            case '桃園縣':
                $('#ifmap')
                    .attr('src',
                          mapTo(24.990331410517026,121.18758092443855,11)
                         );
                break;
            case '新竹市':
                $('#ifmap')
            ...
            case '台中市':
                $('#ifmap')
                    .attr('src',
                          mapTo(24.188016410171,120.71585546057136,11)
                         );
                break;
            case '高雄市':
                $('#ifmap')
                    .attr('src',
                          mapTo(22.71277176570096,120.36154637854011,11)
                         );
                break;
            case '新竹縣':
                $('#ifmap')
                    .attr('src',
                          mapTo(24.69006638401714,121.16861234228523,10)
                         );
                break;
        }
